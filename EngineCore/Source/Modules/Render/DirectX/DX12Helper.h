...
// Link : https://github.com/Microsoft/DirectX-Graphics-Samples/blob/master/Libraries/D3DX12/d3dx12.h
...
struct CD3DX12_RECT :D3D12_RECT
{
	...
	~CD3DX12_RECT() {}
	explicit operator const D3D12_RECT&() const { return *this; }
};
...
struct CD3DX12_VIEWPORT :D3D12_VIEWPORT
{
	...
	~CD3DX12_VIEWPORT() {}
	explicit operator const D3D12_VIEWPORT&() const { return *this; }
};
...
struct CD3DX12_BOX :D3D12_BOX
{
	...
	~CD3DX12_BOX() {}
	explicit operator const D3D12_BOX&() const { return *this; }
};
...
struct CD3DX12_DEPTH_STENCIL_DESC :D3D12_DEPTH_STENCIL_DESC
{
	...
	~CD3DX12_DEPTH_STENCIL_DESC() {}
	explicit operator const D3D12_DEPTH_STENCIL_DESC&() const { return *this; }
};
...
struct CD3DX12_BLEND_DESC :D3D12_BLEND_DESC
{
	...
	~CD3DX12_BLEND_DESC() {}
	explicit operator const D3D12_BLEND_DESC&() const { return *this; }
};
...
struct CD3DX12_RASTERIZER_DESC :D3D12_RASTERIZER_DESC
{
	...
	~CD3DX12_RASTERIZER_DESC() {}
	explicit operator const D3D12_RASTERIZER_DESC&() const { return *this; }
};
...
struct CD3DX12_RESOURCE_ALLOCATION_INFO :D3D12_RESOURCE_ALLOCATION_INFO
{
	...
	explicit operator const D3D12_RESOURCE_ALLOCATION_INFO&() const { return *this; }
};
...
struct CD3DX12_HEAP_PROPERTIES :D3D12_HEAP_PROPERTIES
{
	...
	explicit operator const D3D12_HEAP_PROPERTIES&() const { return *this; }
...
struct CD3DX12_HEAP_DESC :D3D12_HEAP_DESC
{
	...
	explicit operator const D3D12_HEAP_DESC&() const { return *this; }
	bool IsCPUAccessible() const
...
struct CD3DX12_CLEAR_VALUE : D3D12_CLEAR_VALUE
{
	...
	explicit operator const D3D12_CLEAR_VALUE&() const { return *this; }
};
...
struct CD3DX12_RANGE : D3D12_RANGE
{
	...
	explicit operator const D3D12_RANGE&() const { return *this; }
};
...
struct CD3DX12_SHADER_BYTECODE : D3D12_SHADER_BYTECODE
{
	...
	explicit CD3DX12_SHADER_BYTECODE(
	...
	explicit operator const D3D12_SHADER_BYTECODE&() const { return *this; }
};
...
struct CD3DX12_TILED_RESOURCE_COORDINATE :D3D12_TILED_RESOURCE_COORDINATE
{
	...
	explicit operator const D3D12_TILED_RESOURCE_COORDINATE&() const { return *this; }
};
...
struct CD3DX12_TILE_REGION_SIZE :D3D12_TILE_REGION_SIZE
{
	...
	explicit operator const D3D12_TILE_REGION_SIZE&() const { return *this; }
};
...
struct CD3DX12_SUBRESOURCE_TILING :D3D12_SUBRESOURCE_TILING
{
	...
	explicit operator const D3D12_SUBRESOURCE_TILING&() const { return *this; }
};
...
struct CD3DX12_TILE_SHAPE :D3D12_TILE_SHAPE
{
	...
	explicit operator const D3D12_TILE_SHAPE&() const { return *this; }
};
...
struct CD3DX12_RESOURCE_BARRIER :D3D12_RESOURCE_BARRIER
{
	...
	explicit operator const D3D12_RESOURCE_BARRIER&() const { return *this; }
};
...
struct CD3DX12_PACKED_MIP_INFO :D3D12_PACKED_MIP_INFO
{
	...
	explicit operator const D3D12_PACKED_MIP_INFO&() const { return *this; }
};
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT :D3D12_SUBRESOURCE_FOOTPRINT
{
	...
	explicit operator const D3D12_SUBRESOURCE_FOOTPRINT&() const { return *this; }
};
...
struct CD3DX12_ROOT_DESCRIPTOR :D3D12_ROOT_DESCRIPTOR
{
	...
	explicit CD3DX12_ROOT_DESCRIPTOR(
		UINT shaderRegister,
		UINT registerSpace = 0)
	{
...
struct CD3DX12_ROOT_SIGNATURE_DESC :D3D12_ROOT_SIGNATURE_DESC
{
	...
	explicit CD3DX12_ROOT_SIGNATURE_DESC(CD3DX12_DEFAULT)
	{
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE :D3D12_CPU_DESCRIPTOR_HANDLE
{
	...
	explicit CD3DX12_CPU_DESCRIPTOR_HANDLE(CD3DX12_DEFAULT) { ptr = 0; }
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE :D3D12_GPU_DESCRIPTOR_HANDLE
{
	...
	explicit CD3DX12_GPU_DESCRIPTOR_HANDLE(CD3DX12_DEFAULT) { ptr = 0; }
	...
	bool operator==(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other) const
	{
		return ptr == other.ptr;
	}
	bool operator!=(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other) const
...
struct CD3DX12_RESOURCE_DESC :D3D12_RESOURCE_DESC
{
	...
	UINT CalcSubresource(UINT MipSlice, UINT ArraySlice, UINT PlaneSlice) const
	{ return D3D12CalcSubresource(MipSlice, ArraySlice, PlaneSlice, MipLevels, ArraySize()); }

	explicit operator const D3D12_RESOURCE_DESC&() const { return *this; }
};
